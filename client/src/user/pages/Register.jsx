        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div>
              ...
              <button className='bg-blue-800 text-xl text-white font-medium uppercase p-2 rounded-lg w-full opacity-90 hover:opacity-100 mt-4 cursor-pointer' type="submit">Register</button>
            </div>
