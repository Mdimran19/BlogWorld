  ...
  return (
    <div className='items-center text-center'>
      ...
      <form onSubmit={handleRegister} className='pt-5 px-5 sm:pt-12 sm:pl-12 items-center'>
        ...
        <p className='text-xl mt-4'>Upload Date</p>
        ...
        <button type="submit" className='mt-8 w-40 h-12 bg-black text-white rounded-md  shadow-lime-300 shadow-[-5px_5px_0_0] cursor-pointer'>
          Add Blog
        </button>
      </form>
