  ...
  return (
    <div  className=' px-[12%] py-2 scroll-mt-20 '>
      ...
      <h4 className='text-center mb-2 text-lg '>Contact with us</h4>
            ...
            <button type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 '>Submit here  <img src='/Images/rightarrow.png' width={20} height={15} alt=''  /></button>
