...
const Login = () => {
  ...
  return (
    ...
    <div className=" h-[70vh] flex items-center justify-center p-4 dark:bg-slate-800">
      <ToastContainer
       position="top-right"
       autoClose={5000}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div>
              ...
              <button className='bg-blue-800 text-xl text-white font-medium uppercase p-2 rounded-lg w-full opacity-90 hover:opacity-100 mt-4 cursor-pointer' type="submit">Login</button>
            </div>
            <div class="text-[18px] text-center mt-4">
              <p>Don't have an account? <a class="capitalize text-blue-800 hover:underline cursor-pointer" href="/register">register</a><br /><a className='cursor-pointer z-50 shadow-[-2px_2px_2px_2px] bg-amber-200 px-2 rounded-md' href="/login">For Admin</a></p>
            </div>
          </div>
        </form>
      </div>
